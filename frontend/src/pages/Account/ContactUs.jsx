        ...
        return (
            <div className="animate-slideUp flex flex-col items-center justify-center h-full min-h-[400px] text-center p-8">
                ...
                <p className="text-gray-600 dark:text-gray-400 max-w-md text-lg">
                    Thanks for reaching out {userData?.username}. We've received your message and will get back to you shortly at <span className="text-indigo-600 dark:text-indigo-400">{userData?.email}</span>.
                </p>
            </div>
        );
    }
            ...
            <div className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl p-8 shadow-xl backdrop-blur-sm">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-black/20 border border-gray-300 dark:border-white/10 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors ${userData?.email ? 'opacity-70 cursor-not-allowed' : ''}`}
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="relative">
                            ...
                            <textarea
                                ...
                                name="message"
                                rows="5"
                                className="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-black/20 border border-gray-300 dark:border-white/10 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors resize-none mb-1"
                    ...
                    <button
                        ...
                        className="w-full bg-indigo-600 hover:bg-indigo-700 dark:bg-gradient-to-r dark:from-indigo-600 dark:to-violet-600 text-white font-bold py-3 px-6 rounded-xl shadow-md hover:shadow-lg dark:hover:shadow-indigo-500/20 transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2 cursor-pointer"
                    >
                        {state.submitting ? (
                            <>Sending...</>
                        ) : (
